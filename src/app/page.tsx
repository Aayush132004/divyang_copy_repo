      ...
      <header className="bg-orange-400 py-3 px-6">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="flex items-center space-x-8">
            ...
            <button className="bg-white text-blue-900 px-6 py-2 rounded-md font-medium hover:bg-gray-100 transition">Login</button>
            <button className="bg-blue-900 text-white px-6 py-2 rounded-md font-medium hover:bg-blue-800 transition">Register</button>
          </nav>
        </div>
      </header>
